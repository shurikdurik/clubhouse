      ...
      <div className="container d-flex align-items-center justify-content-between">
        ...
        <Link href="/profile/1">
          <div className="d-flex align-items-center cup">
            ...
            <Avatar src={'https://images.pexels.com/photos/1704488/pexels-photo-1704488.jpeg?cs=srgb&dl=pexels-suliman-sallehi-1704488.jpg&fm=jpg'} width="40px" height="40px" />
          </div>
        </Link>
      </div>
    </div>
